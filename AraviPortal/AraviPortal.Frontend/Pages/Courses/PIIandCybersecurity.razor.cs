...
public partial class PIIandCybersecurity
{
    ...
    private void GoHome()
    {
        NavigationManager.NavigateTo("/AccessToPublications"); ; // Asume que tu página de inicio es la raíz "/"
    }

    private void GoToNextPage()
    {
        NavigationManager.NavigateTo("/"); ; // Reemplaza "/nextpage" con la ruta de tu siguiente página
    }

    protected override void OnInitialized()
    {
        VideoUrl = "videos/Proteccion_de_datos_y_Ciberseguridad_3.mov";
    }
