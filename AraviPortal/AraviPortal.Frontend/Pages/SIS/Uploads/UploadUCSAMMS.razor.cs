...
public partial class UploadUCSAMMS
{
    ...
    {
        NavigationManager.NavigateTo("/UploadMROBacklog");
    }
    ...
    private async Task UploadFile()
    {
        ...
        {
            statusMessage = Localizer["FileNotSelected"];
            Snackbar.Add(statusMessage, Severity.Warning);
        ...
        try
        {
            ...
            var response = await HttpClient.PostAsync("api/UploadAMMS/UCSAMMS", content);
