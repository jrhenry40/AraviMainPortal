...
public partial class UploadMROShipping
{
    ...
    {
        NavigationManager.NavigateTo("/uploadSummary");
    }
    ...
    private async Task UploadFile()
    {
        ...
        try
        {
            ...
            var response = await HttpClient.PostAsync("api/UploadSISShipping/upload-shipping", content);
